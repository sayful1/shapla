...
* Added - Add page title bar section.
...
* Added - Add support for generating JSON LD structured data for breadcrumb.
* Added - Add Page title bar customize options for background color, background image, and full typography 
* Added - Add Page title bar customize options for text alignment, padding and border color
* Added - Add body typography with google fonts, font size, font weight, color and more.
* Added - Add headers typography with google fonts, font size, font weight, color and more.
* Added - Add background image feature for footer widget area.
* Dev - Add static css file generator for dynamic css generated by customize.
